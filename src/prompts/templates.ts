...
type TemplateCommitFormat = Exclude<CommitStyle, 'auto'>;
...
export function getTemplate(format: CommitStyle): string {
...
export function getSelectableStyles(): CommitStyle[] {
  return ['auto', 'plain', 'conventional', 'angular', 'karma', 'semantic', 'emoji', 'emojiKarma', 'google', 'atom'];
}
